...
const UUID = process.env.UUID || '9afd1229-b893-40c1-84dd-51e7ce204913'; // 浣跨敤鍝悞v1,鍦ㄤ笉鍚岀殑骞冲彴杩愯闇€淇敼UUID,鍚﹀垯浼氳鐩�
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '';          // 固定通道核名称，留空则启用默认通道
const ARGO_AUTH = process.env.ARGO_AUTH || '';              // 固定通道密码 json 或 token，留空则启用临时通道，json 获取地址：https://json.zone.id
